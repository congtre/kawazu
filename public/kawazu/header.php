            ...
            <div class="l_header_fixed">
                <div class="l_header_fixed__inner">
                    <ul class="l_header_fixed__mlist">
                        ...
                        <li class="l_header_fixed__mlist_item">
                            <a href="<?php echo esc_url(home_url()); ?>/track_record/" class="l_header_fixed__mlist_link">
                                <span class="ja">運搬実績</span>
                                <span class="en">Transportation record</span>
                            </a>
                        </li>
                        <li class="l_header_fixed__mlist_item">
                            <a href="<?php echo esc_url(home_url()); ?>/permit_list/" class="l_header_fixed__mlist_link">
                                <span class="ja">許可一覧</span>
                                <span class="en">List of permits</span>
                            </a>
                        </li>
                        <li class="l_header_fixed__mlist_item">
                            <a href="<?php echo esc_url(home_url()); ?>/for_message/" class="l_header_fixed__mlist_link">
                                <span class="ja">お問い合わせ</span>
                                <span class="en">Contact us</span>
                            </a>
                        </li>
                        <li class="l_header_fixed__mlist_item recruit">
                            <a href="<?php echo esc_url(home_url()); ?>/recruit_page/" class="l_header_fixed__mlist_link">
                    ...
                    <a href="<?php echo esc_url(home_url()); ?>/recruit_page/" class="l_header_fixed__banner">
                    ...
                    <div class="l_header_fixed__last">
                        ...
                        <div class="l_header_fixed__last_btn">
                            <a href="https://www.instagram.com/kawazu2801/" class="l_header_fixed__last_sns" target="_blank" rel="noopener noreferrer">Instagram</a>
                        </div>
                    </div>
                </div>
            </div>
